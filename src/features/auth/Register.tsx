      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4 rounded-md shadow-sm">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="email"
                {...register('email')}
                className="relative block w-full appearance-none border-b border-l border-r border-slate-300 px-3 py-3 text-slate-900 placeholder-slate-500 focus:z-10 focus:border-primary focus:outline-none focus:ring-primary sm:text-sm dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:placeholder-slate-400"
                placeholder="E-mail"
              />
              {errors.email && (
          ...
          <div>
            ...
            >
              {isSubmitting ? <Loader2 className="animate-spin w-5 h-5" /> : 'Cadastrar'}
            </button>
          </div>
        </form>
